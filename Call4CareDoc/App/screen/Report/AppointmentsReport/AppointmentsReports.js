      ...
      <View style={styles.wrapperView}>
        ...
        <SafeAreaView style={styles.wholeView}>
          ...
          <View style={{ marginTop: 20 }}>
            <Text style={{ fontSize: 30 }}>Appointments</Text>
          ...
          />
          <Text style={{ fontSize: 25, marginTop: 30 }}>Advance Filter</Text>
          <Text style={{ marginTop: 8 }}>Doctors</Text>
          <TextInput
          ...
          <RNPickerSelect
            ...
            items={[
              ...
              { label: 'Confirmed', value: 'Invoiced Income' },
          ...
          <View style={styles.TotalpatientBox}>
                    <View>
                        <Text style={{fontSize:20,color:"grey"}}>Total Appointments</Text>
                        <Text style={{fontSize:20, fontWeight:'bold',alignSelf:"center"}}>16</Text>
                    </View>
         </View>
